...
(function($) {
    ...
    */
     ...
     * syntaxes and multiple and more easily expandable adm.</p>
     * 
     ...
     * If a adm is detected which is not available, jsDate defaults to 'en'.
     * Additional localizations can be added after jsDate loads.  After adding a adm,
     ...
     * if it cannot figure out a locale of if the locale does not have a adm defined.
